   ...
   <body>
      <div class="header-outs" id="home">
         <div class="header-w3layouts">
            ...
            <div class="headr-title text-center">
               <h1><a class="navbar-brand" href="index.html"><span class="fab fa-servicestack"></span>EMPTY SYSTEM</a></h1>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
               ...
               <div class="collapse navbar-collapse  nav-fill " id="navbarSupportedContent">
                  <ul class="navbar-nav nav-pills nav-fill">
                     ...
                     <li class="nav-item">
                        <a href="gallery.html" class="nav-link">Liên hệ</a>
                     </li>
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                           <a class="dropdown-item" href="blog.html">Tiếng Việt</a>
                           <a class="dropdown-item" href="blog2.html">English</a>
                        ...
                        <div class="container">
                           <div class="slider-info ">
                              <div class="upper-info text-left">
                                 <h5>Theo đuổi giấc mơ của bạn</h5>
                                 <div class="bottom-info">
                                    <h4>XÂY DỰNG TƯƠNG LAI</h4>
                                 </div>
                              </div>
      ...
      <section class="about py-lg-4 py-md-3 py-sm-3 py-3" id="about">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-4">
            <h3 class="title text-center mb-lg-5 mb-md-4  mb-sm-4 mb-3">ĐÂY LÀ GÌ?</h3>
            <div class="agile-abt-info ">
               <div class="info-sub-w3 pb-lg-3 pb-md-2 pb-2">
                  <p>Đây là trang web dành cho nhân viên công ty EMPTY SYSTEM, nơi cập nhật những thông tin mới nhất về
                     lịch nghỉ, thông tin nhân viên, dánh sách thi đua, các hoạt động của công ty. Mọi thông tin quan
                      trọng đều được cập nhật sớm nhất trên trang chủ tại mục hoạt động, cập nhật thường xuyên để không 
                      bỏ lỡ nhưng thông tin quan trọng.
                  </p>
               </div>
            </div>
            <!--text slider -->
                  ...
                  <ul class="slides">
                     <li>
                        <div class="row">
                           ...
                           <div class="col-lg-9 about-text-right">
                              <p>Luôn cập nhật những thôn tin mới nhật về tất cả các hoạt động trong công ty
                              </p>
                           </div>
                        </div>
                     </li>
                     <li>
                        <div class="row">
                           ...
                           <div class="col-lg-9 about-text-right">
                              <p>Quản lý thông tin cá nhân, lương, thành tích và kỉ luật.
                              </p>
                           </div>
                        </div>
                     </li>
                     <li>
                        <div class="row">
                           ...
                           <div class="col-lg-9 about-text-right">
                              <p>Cập nhật TOP 5 thi đua hàng tháng, người trong TOP là những người không có kỉ luật như đi làm muộn,
                                  hay tham gia các hoạt động chung, nhận được sự đánh giá cao của đồng nghiệp.
                              </p>
                           </div>
                        </div>
                     </li>
            ...
            <div class="row">
               ...
               <div class="col-lg-6 col-md-6 jst-wthree-text">
                  <h2>"CÙNG CỐNG HIẾN CHO SỰ PHÁT TRIỂN CỦA CÔNG TY"
                  </h2>
                  <div class="about-text-right ">
                     <p class="clr-black">CEO, FOUNDER<br>  NGUYỄN VĂN TRUNG</p>
                  </div>
               </div>
            </div>
         </div>
      ...
      <section class="blog py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            <h3 class="title text-center mb-lg-5 mb-md-4 mb-sm-4 mb-3">TOP 10
                NHÂN VIÊN XUẤT SẮC</h3>
            <div class="row blog-top-grids">
                  ...
                  <div class="least-w3layouts-text-gap">
                     <div class="row  py-3">
                        <div class="col-md-4 col-sm-4 news-img">
                           <img src="resources/images/l1.jpg" alt="" class="image-fluid">
                        </div>
                        <div class="col-md-8 col-sm-8 news-agile-text ">
                           ...
                           <div class="news-date my-3">
                              <ul>
                                 <li><span class="far fa-calendar-check" ></span><a href="#">01/05/2000</a></li>
                                 <li><span class="fas fa-id-card"></span><a href="#">SF000</a></li>
                                 <li><span class="fas fa-level-up-alt"></span><a href="#">Lv 6</a></li>
                              </ul>
                           </div>
               ...
               <div class="col-lg-6 left-side-agile">
                  <div class="least-w3layouts-text-gap">
                     <div class="row py-3">
                        <div class=" col-md-4 col-sm-4 news-img">
                           <img src="resources/images/l2.jpg" alt="" class="image-fluid">
                        </div>
                        <div class=" col-md-8 col-sm-8 news-agile-text ">
                           <h4>
                              Nguyễn Văn Trung
            ...
            <div class="row blog-top-grids">
               <div class="col-lg-6 left-side-agile mb-3">
                  <div class="least-w3layouts-text-gap">
                     <div class="row py-3">
                        <div class=" col-md-4 col-sm-4 news-img">
                           <img src="resources/images/l3.jpg" alt="" class="image-fluid">
                        </div>
                        <div class=" col-md-8 col-sm-8 news-agile-text ">
                           <h4>
                              Nguyễn Văn Trung
               ...
               <div class="col-lg-6 left-side-agile">
                  <div class="least-w3layouts-text-gap">
                     <div class="row py-3">
                        <div class=" col-md-4 col-sm-4 news-img">
                           <img src="resources/images/l4.jpg" alt="" class="image-fluid">
                        </div>
                        <div class=" col-md-8 col-sm-8 news-agile-text ">
                           <h4>
                              Nguyễn Văn Trung
      ...
      <section class="team py-lg-4 py-md-3 py-sm-3 py-3">
         <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
            <h3 class="title text-center clr mb-lg-5 mb-md-4 mb-sm-4 mb-3">TOP 3 NHÓM THÀNH TÍCH NỔI BẬT</h3>
            <div class="row">
               <!-- Team member -->
                        ...
                        <div class="frontside">
                           <div class="card">
                              <div class="card-body text-center">
                                 <p><img src="resources/images/l2.jpg" alt="" class="image-fluid"></p>
                                 <h4 class="card-title mt-3">NHÓM 1</h4>
                  ...
                  <div class="image-flip">
                     <div class="mainflip">
                        <div class="frontside">
                           <div class="card">
                              <div class="card-body text-center">
                                 <p><img src="resources/images/l1.jpg" alt="" class="image-fluid"></p>
                                 <h4 class="card-title mt-3">NHÓM 2</h4>
                                 <p class="card-text mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed</p>
                  ...
                  <div class="image-flip">
                     <div class="mainflip">
                        <div class="frontside">
                           <div class="card">
                              <div class="card-body text-center">
                                 <p><img src="resources/images/l3.jpg" alt="" class="image-fluid"></p>
                                 <h4 class="card-title mt-3">NHÓM 3</h4>
                                 <p class="card-text mb-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed</p>
                                 <a href="#" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                              </div>
                           </div>
            ...
            <div class="row">
               <div class="col-lg-4 w3-agile-post-grids">
                  <div class="w3-agile-post-img">
                     ...
                     <img src="resources/images/bb1.jpg" alt="" class="img-fluid">
                     </a>
                     <div class="blog-info">
                        <a href="about.html" data-toggle="modal" data-target="#exampleModalLong">
                           <ul>
                  ...
                  <div class="w3-agile-post-info text-left">
                     <h4 class="mt-2"><a href="#" data-toggle="modal" data-target="#exampleModalLong">Kế hoạch tháng 1</a></h4>
               ...
               <div class="col-lg-4 w3-agile-post-grids">
                  <div class="w3-agile-post-img">
                     <a href="about.html" data-toggle="modal" data-target="#exampleModalLong">
                     <img src="resources/images/bb12.jpg" alt="" class="img-fluid">
                     </a>
                     <div class="blog-info">
                        <a href="about.html" data-toggle="modal" data-target="#exampleModalLong">
                           <ul>
                  ...
                  <div class="w3-agile-post-info text-left">
                     <h4 class="mt-2"><a href="#" data-toggle="modal" data-target="#exampleModalLong">Kế hoạch hoạt động tháng 2</a></h4>
                     <p class="text-left my-3">Xây dự kế hoạch tháng 01/2020.</p>
                     <div class="outs-blog-text">
                        <a href="about.html">Đọc thêm</a>
                     </div>
               ...
               <div class="col-lg-4 w3-agile-post-grids">
                  <div class="w3-agile-post-img">
                     <a href="about.html" data-toggle="modal" data-target="#exampleModalLong">
                     <img src="resources/images/bb3.jpg" alt="" class="img-fluid">
                     </a>
                     <div class="blog-info">
                        <a href="about.html" data-toggle="modal" data-target="#exampleModalLong">
                           <ul>
                  ...
                  <div class="w3-agile-post-info text-left">
                     <h4 class="mt-2"><a href="#" data-toggle="modal" data-target="#exampleModalLong">Kế hoạch tháng 3</a></h4>
                     ...
                     <div class="addres-up">
                        <ul>
                           <li  class="d-flex pb-md-3 pb-3">
                              ...
                              <p class="d-flex">225 Cầu Giấy - Quận Cầu Giấy - Hà Nội</p>
                           </li>
                           <li class="d-flex pb-md-3 pb-3">
                              <span class="fas fa-phone-volume d-flex" aria-hidden="true"></span>
                              <p class="d-flex">+8459747683</p>
                           </li>
                           <li  class="d-flex pb-md-3 pb-3">
                              <span class="far fa-envelope d-flex"></span>
                              <p class="d-flex"><a href="mailto:Trung.nguyen.van1520@gmail.com">Trung.nguyen.van1520@gmail.com</a></p>
                           </li>
                           <li class="d-flex pb-md-3 pb-3">
                              <span class="fas fa-fax d-flex"></span>
                              <p class="d-flex">(+84)359747683</p>
                           </li>
                           <li  class="d-flex">
                              <span class="fab fa-windows d-flex" aria-hidden="true"></span>
                              <p class="d-flex">http//emptysystem.com</p>
                           </li>
                        </ul>
                     </div>
                  ...
                  <div class="wthree-left-right col-lg-4 col-md-4 col-sm-12">
                     ...
                     <div class="footer-post d-flex mb-2">
                        <div class="agileinfo_footer_grid1 mr-2">
                           ...
                           <img src="resources/images/f1.jpg" alt=" " class="img-fluid">
                           </a>
                        </div>
                        <div class="agileinfo_footer_grid1 mr-2">
                           <a href="resources/gallery.html">
                           <img src="resources/images/f2.jpg" alt=" " class="img-fluid">
                           </a>
                        </div>
                        <div class="agileinfo_footer_grid1">
                           <a href="resources/gallery.html">
                           <img src="resources/images/f3.jpg" alt=" " class="img-fluid">
                           </a>
                        </div>
                     </div>
                     <div class="footer-post d-flex">
                        <div class="agileinfo_footer_grid1 mr-2">
                           <a href="resources/gallery.html">
                           <img src="resources/images/f4.jpg" alt=" " class="img-fluid">
                           </a>
                        </div>
                        <div class="agileinfo_footer_grid1 mr-2">
                           <a href="resources/gallery.html">
                           <img src="resources/images/f5.jpg" alt=" " class="img-fluid">
                           </a>
                        </div>
                        <div class="agileinfo_footer_grid1">
                           <a href="resources/gallery.html">
                           <img src="resources/images/f6.jpg" alt=" " class="img-fluid">
                           </a>
                        </div>
                     </div>
                  </div>
