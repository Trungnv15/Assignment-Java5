			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-xlg-3 col-md-5">
						...
						<div style="font-weight: 550;">* chú thích:</div>
						<div style="font-weight: 90px; font-size: 16px;">
							<span style="padding-left: 7px;"><i
								class="fas fa-level-up-alt"></i> Là Level (1-10)</span>
						</div>
						<div style="font-weight: 90px; font-size: 16px;">
							<span style="padding-left: 7px;"><i class="far fa-smile"></i>
								Là tổng điểm thưởng</span>
						</div>
						<div style="font-weight: 90px; font-size: 16px;">
							<span style="padding-left: 7px;"><i
								class="far fa-sad-tear"></i> Là tổng điểm phạt</span>
						</div>
						<div style="font-weight: 90px; font-size: 16px;">
							<span style="padding-left: 7px;"><i class="fas fa-gift"></i>
								Là thành tích thi đua, được tính bằng cách: <b
								style="color: black;">Điểm thưởng - Điểm phạt = thành tích
									thi đua</b></span>
						</div>
					</div>
					<!-- Column -->
						...
						<div class="card">
							<div class="card-block">
								<form class="form-horizontal form-material">
									...
									<!-- Lương -->
									<div class="form-group">
										<label class="col-md-12">Lương/Tháng</label>
										<div class="col-md-12">
